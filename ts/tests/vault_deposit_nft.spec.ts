...
describe("vault_deposit_nft.ts", () => {
  it("success path builds Deposit NFT instruction (discriminant=5) and sends tx", async () => {
    jest.resetModules();
    ...
    jest.isolateModules(() => {
      require("../cluster1/vault_deposit_nft");
    });
